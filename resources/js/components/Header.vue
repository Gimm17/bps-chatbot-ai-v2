<template>
  <header class="w-full bg-white/95 backdrop-blur-md border-b border-slate-200/80 sticky top-0 z-30 shadow-2xs h-13 sm:h-15 px-3 sm:px-4">
    <div class="max-w-3xl mx-auto flex items-center justify-between h-full w-full">
      <!-- Logo & Brand Title -->
      <div class="flex items-center gap-2 sm:gap-2.5 cursor-pointer select-none min-w-0" @click="$emit('reset')">
        ...
        <div class="flex flex-col min-w-0">
          ...
          <span class="text-[10.5px] sm:text-xs text-slate-500 hidden sm:block leading-tight mt-0.5">Asisten Statistik Publik Resmi</span>
        </div>
      </div>
